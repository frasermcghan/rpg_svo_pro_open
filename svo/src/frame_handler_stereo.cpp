...
UpdateResult FrameHandlerStereo::processFrameBundle(const bool &kf_decision) {
...
void FrameHandlerStereo::addImages(const cv::Mat &img_left,
  ...
  // TODO: deprecated
  addImageBundle({img_left, img_right}, kf_decision, timestamp);
}
...
UpdateResult FrameHandlerStereo::processFrame(const bool &kf_decision) {
  // ---------------------------------------------------------------------------
  // tracking
